...
#pragma weak pmpi_file_write_ordered__ = ompi_file_write_ordered_f

#pragma weak PMPI_File_write_ordered_f = ompi_file_write_ordered_f
#pragma weak PMPI_File_write_ordered_f08 = ompi_file_write_ordered_f
#else
OMPI_GENERATE_F77_BINDINGS (PMPI_FILE_WRITE_ORDERED,
...
#pragma weak mpi_file_write_ordered__ = ompi_file_write_ordered_f
...
void ompi_file_write_ordered_f(MPI_Fint *fh, char *buf, MPI_Fint *count,
