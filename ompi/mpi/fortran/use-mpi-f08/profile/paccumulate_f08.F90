...
subroutine PMPI_Accumulate_f08(origin_addr,origin_count,origin_datatype,&
   ...
   call ompi_accumulate_f(origin_addr,origin_count,origin_datatype%MPI_VAL,target_rank,&
